...
def create_main_thermal_time_series(plot: bool = False):
    ...
    if plot:
        ...
        plt.tight_layout()
        plt.savefig(
            "/Users/k.jones/Desktop/blogs/blog_posts/16_thermal_anomaly_modis_main.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
...
def create_spatial_thermal_heatmap(plot: bool = False):
    ...
    if plot:
        ...
        ax2.contour(
            X, Y, z_scores, levels=[3], colors="red", linewidths=3, linestyles="--"
        )
        ...
        plt.suptitle(
            "Spatial Thermal Anomaly Analysis", fontsize=14, fontweight="bold", y=1.00
        )

        plt.tight_layout()
        plt.savefig(
            "/Users/k.jones/Desktop/blogs/blog_posts/16_thermal_anomaly_spatial.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
